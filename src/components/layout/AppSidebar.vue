    ...
    >
      <div class="flex flex-col gap-4">
        <div class="flex justify-center mb-2 px-3">
          ...
          />
          <img
            src="@/assets/vectors/qallab-favicon.svg"
            alt=""
            class="w-15"
            v-else
          />
        ...
        <div class="q-sidebar-toggle z-10" v-if="!isMobile">
          <v-btn
            size="x-small"
            icon
            class="bg-qallab-yellow text-white shadow-md !rounded-full"
        ...
        >
          ...
          <v-list-item
            to="/"
            value="home"
            :class="{ '!mx-1 gap-5': !isSidebarExpanded }"
              ...
              >
                ...
                <template #title>
                  <div class="flex-1">
                    <span
                      class="font-semibold"
                      :class="isProductsActive ? '!text-[#1570EF]' : ''"
                      >المنتجات</span
                    >
                  </div>
                </template>
            ...
            <div class="relative mt-1 ps-10 pe-4 text-sm">
              ...
              >
                ...
                <li v-if="canViewBuildingMaterialPriceLists" class="relative">
                  <router-link
                    to="/products/building-material-products-prices"
                    :class="[
                      isMenuItemActive(
                ...
                <li v-if="canViewGeneralPriceLists" class="relative">
                  <router-link
                    to="/products/general-products-prices"
                    :class="[
                ...
                <li v-if="canViewProductionCapacity" class="relative">
                  <router-link
                    to="/products/production-capacity"
                    :class="[
              ...
              >
                ...
                <template #title>
                  <div class="flex-1">
                    <span
                      class="font-semibold"
                      :class="isServicesActive ? '!text-[#1570EF]' : ''"
                      >الخدمات</span
                    >
                  </div>
                </template>
          ...
          <v-list-group v-if="hasAnySalesPermission" value="sales" class="mt-1">
              ...
              >
                ...
                <template #title>
                  <div class="flex-1">
                    <span
                      class="font-semibold"
                      :class="isSalesActive ? '!text-[#1570EF]' : ''"
                      >المبيعات</span
                    >
                  </div>
                </template>
            ...
            <div class="relative mt-1 ps-10 pe-4 text-sm">
              ...
              >
                <li class="relative">
                  <router-link
                    to="/sales/requests/material-product/list"
                    :class="[
                ...
                <li class="relative">
                  <router-link
                    to="/sales/quotations/material-product/list"
                    :class="[
              ...
              >
                ...
                <template #title>
                  <div class="flex-1">
                    <span
                      class="font-semibold"
                      :class="isProjectsActive ? '!text-[#1570EF]' : ''"
                      >المشاريع</span
                    >
                  </div>
                </template>
          ...
          <!-- المشتريات -->
          <v-list-group
            v-if="hasAnyPurchasesPermission"
            value="purchases"
            class="mt-1"
          >
            <template #activator="{ props, isOpen }">
              ...
              >
                ...
                <template #title>
                  <div class="flex-1">
                    <span
                      class="font-semibold"
                      :class="isPurchasesActive ? '!text-[#1570EF]' : ''"
                      >المشتريات</span
                    >
                  </div>
                </template>
            ...
            <div class="relative mt-1 ps-10 pe-4 text-sm">
              ...
              >
                ...
                <li v-if="canViewSupplierSettlements" class="relative">
                  <router-link
                    to="/suppliers/supplier-settlement"
                    :class="[
              ...
              >
                ...
                <li
                  class="relative"
                  v-if="canViewBuildingMaterialPriceRequests"
                >
                  <router-link
                    to="/purchases/requests/material-product/list"
                    :class="[
                ...
                <li class="relative">
                  <router-link
                    to="/purchases/requests/fuels/list"
                    :class="[
                ...
                <li class="relative">
                  <router-link
                    to="/purchases/quotations/fuels/list"
                    :class="[
              ...
              >
                <li class="relative">
                  <router-link
                    to="/purchases/orders/material-product/list"
                    :class="[
                ...
                <li class="relative">
                  <router-link
                    to="/purchases/receiving-docs/list"
                    :class="[
              ...
              >
                <li class="relative">
                  <router-link
                    to="/purchases/purchase-invoices/list"
                    :class="[
              ...
              >
                ...
                <template #title>
                  <div class="flex-1">
                    <span
                      class="font-semibold"
                      :class="isFinanceActive ? '!text-[#1570EF]' : ''"
                      >المالية</span
                    >
                  </div>
                </template>
              ...
              >
                ...
                <template #title>
                  <div class="flex-1">
                    <span
                      class="font-semibold"
                      :class="isUsersActive ? '!text-[#1570EF]' : ''"
                      >المستخدمين</span
                    >
                  </div>
                </template>
              ...
              >
                ...
                <template #title>
                  <div class="flex-1">
                    <span
                      class="font-semibold"
                      :class="isReportsActive ? '!text-[#1570EF]' : ''"
                      >التقارير</span
                    >
                  </div>
                </template>
              ...
              >
                ...
                <template #title>
                  <div class="flex-1">
                    <span
                      class="font-semibold"
                      :class="isSettingsActive ? '!text-[#1570EF]' : ''"
                      >الإعدادات</span
                    >
                  </div>
                </template>
            ...
            <div class="relative mt-1 ps-10 pe-4 text-sm">
              ...
              >
                <li v-if="canViewCategories" class="relative">
                  <router-link
                    to="/settings/products-categories/list"
                    :class="[
                ...
                <li v-if="canViewServiceCategories" class="relative">
                  <router-link
                    to="/settings/services-categories/list"
                    :class="[
                ...
                <li v-if="canViewTreeCategories" class="relative">
                  <router-link
                    to="/settings/products-categories/tree"
                    :class="[
                ...
                <li v-if="canViewTreeServiceCategories" class="relative">
                  <router-link
                    to="/settings/services-categories/tree"
                    :class="[
              ...
              >
                ...
                <li v-if="canViewAccountTypes" class="relative">
                  <router-link
                    to="/settings/account-types/list"
                    :class="[
                ...
                <li v-if="canViewTestMethodologies" class="relative">
                  <router-link
                    to="/settings/test-methodology/list"
                    :class="[
                ...
                <li v-if="canViewSystemStatuses" class="relative">
                  <router-link
                    to="/settings/system-statuses/list"
                    :class="[
                ...
                <li class="relative" v-if="canViewDocStatusTransitions">
                  <router-link
                    to="/settings/doc-status-transitions/list"
                    :class="[
      ...
      <div class="mt-15 px-2">
        <a href="#" class="block relative" v-if="isSidebarExpanded">
          ...
          >
            <v-icon size="20" class="text-qallab-blue font-bold"
          ...
          >
            <img
              src="@/assets/vectors/qallab-iphone.svg"
              class="transform scale-[1.5] translate-x-[-15px] translate-y-[-20px] w-12"
            />
            <span class="font-bold text-primary-900 text-end"
              >Download our <br />
              Mobile app</span
            >
          </div>
        ...
        <div v-else class="flex justify-center">
          <v-btn
            icon
            size="x-small"
            class="bg-white text-qallab-blue rounded-full shadow-sm"
          >
            <v-icon size="18" class="text-qallab-blue"
              >mdi-arrow-top-right</v-icon
            >
          </v-btn>
        </div>
...
.q-sidebar-drawer.v-navigation-drawer--rail.v-navigation-drawer--expand-on-hover:hover
  .q-sidebar-toggle,
