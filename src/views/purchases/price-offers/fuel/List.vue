...
const handleEdit = (item: any) => {
    router.push({ name: "RequestForQuotationFuelEdit", params: { id: item.id } });
}
...
<template>
    <default-layout>
        <div class="pricesOffers-page">
            <PageHeader :icon="GridIcon" title-key="pages.requestForQuotationFuel.title"
                description-key="pages.requestForQuotationFuel.description" />
