        ...
        <div class="category-view-page -mx-6">
            ...
            <div>
                ...
                <div class="flex flex-wrap items-center gap-3 mb-6 text-sm px-6">
                    ...
                    <span class="text-lg text-gray-300">/</span>
                    <router-link to="/purchases/receiving-docs/list" class="text-gray-600 hover:text-primary-600">
                        {{ t('purchases.receivingDocs.view.listCrumbMaterial') }}
                    </router-link>
                    <span class="text-lg text-gray-300">/</span>
...
const itemHeaders = computed(() => [
    ...
    { title: t('purchases.receivingDocs.form.tableHeaders.qtyFromSupplierShort'), key: 'quantity_from_supplier' },
    { title: t('purchases.receivingDocs.form.tableHeaders.qtyFromTransportShort'), key: 'quantity_from_transport' },
    { title: t('purchases.receivingDocs.form.tableHeaders.qtyFromCustomerShort'), key: 'quantity_from_customer' },
])
