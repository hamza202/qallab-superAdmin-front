...
const confirmBulkDelete = async () => {
  try {
    ...
    success(
      t('purchases.requests.buildingMaterials.list.messages.bulkDeleteSuccess', {
...
const handleView = (item: any) => {
    router.push({ name: "RequestForQuotationMaterialProductView", params: { id: item.uuid } });
};
...
<template>
  <default-layout>
    ...
    <StatusChangeFeature
      ...
      :change-status-url="`/purchases/building-materials/${itemToChangeStatus?.uuid}/change-status`"
