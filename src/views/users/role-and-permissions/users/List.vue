...
const rolesFilter = ref<number | null>(null)
...
const fetchUsers = async () => {
    try {
        ...
        if (rolesFilter.value !== null) params.append('role', String(rolesFilter.value))
...
const handleStatusChange = async (user: User, newStatus: boolean) => {
    try {
        ...
        await api.patch(`/users/${user.id}/change-status`, {
            is_active: newStatus
        })
