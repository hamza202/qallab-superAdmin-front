...
<template>
  <AppDialog v-model="internalOpen" :title="t('form.buttons.addCountry')" :max-width="640">
    <template #title>
    ...
    <v-form ref="formRef" v-model="isFormValid" @submit.prevent>
      ...
      <div v-else>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-3 gap-y-5 mb-4">
          ...
          <TextInput v-model="form.code3" :label="t('form.fields.code3.label')" :placeholder="t('form.fields.code3.placeholder')" :rules="[required(), exactLength(3)]"
            :hide-details="false" :error-messages="formErrors['code3']" @input="delete formErrors['code3']" />

          <TextInput v-model="form.phoneCode" :label="t('form.fields.phoneCode.label')" :placeholder="t('form.fields.phoneCode.placeholder')"
          ...
          <div>
            <span class="text-sm font-semibold text-gray-700 block mb-1">{{ t('form.fields.isDefault.label') }}</span>
            <div class="flex items-center gap-3">
