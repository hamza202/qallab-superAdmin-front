...
const accountTypesIcon = `<svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <default-layout>
    <div class="account-types-page">
      <PageHeader
        ...
        title-key="pages.accountTypes.title"
      ...
      <div class="bg-gray-50 rounded-md -mx-6">
        ...
        >
          <div class="flex flex-wrap gap-3 flex-1 order-1 sm:order-2 justify-end sm:justify-start">
            ...
            <v-select
              ...
              class="w-full sm:w-40 bg-white"
            />
            <v-menu v-model="createdAtMenu" :close-on-content-click="false" transition="scale-transition">
              <template #activator="{ props }">
                <v-text-field
                  ...
                  class="w-full sm:w-48 bg-white"
                />
              </template>
              <v-date-picker
                v-model="filterCreatedAt"
                color="primary"
                @update:model-value="createdAtMenu = false"
              />
            </v-menu>
          </div>
        </div>
        ...
        <DataTable
          :headers="accountTypesTableHeaders"
          :items="accountTypesTableItems"
          show-actions
          show-checkbox
          @edit="handleEditAccountType"
          @delete="handleDeleteAccountType"
          @select="handleSelectAccountType"
          @selectAll="handleSelectAllAccountTypes"
        />

        <AccountTypeFormDialog
          v-model="showAccountTypeDialog"
