...
<template>
  <AppDialog v-model="internalOpen" :title="t('form.ui.addUnit')" :max-width="640">
    <template #title>
    ...
    <v-form ref="formRef" v-model="isFormValid" @submit.prevent>
      ...
      <div v-else>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-3 gap-y-5 mb-4">
          ...
          <TextInput v-model="form.code" :label="t('form.fields.unitCode.label')" :placeholder="t('form.fields.unitCode.label')" :rules="[required()]"
            :hide-details="false" :error-messages="formErrors['unit_code']" @input="delete formErrors['unit_code']" />

          <SelectInput v-model="form.parentId" :label="t('form.fields.parentUnit.label')" :placeholder="t('common.form.choose')"
          ...
          <SelectWithIconInput v-model="form.type" :label="t('form.fields.type.label')" :placeholder="t('form.fields.type.placeholder')" :items="typeItems" :rules="[required()]"
