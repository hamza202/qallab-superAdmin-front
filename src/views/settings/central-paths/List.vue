...
const siteTrackIcon = `<svg width="16" height="19" viewBox="0 0 16 19" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9.33333 1.22461V4.66673C9.33333 5.13344 9.33333 5.36679 9.42416 5.54505C9.50406 5.70185 9.63154 5.82934 9.78834 5.90923C9.9666 6.00006 10.2 6.00006 10.6667 6.00006H14.1088M11 10.1667H4.33333M11 13.5H4.33333M6 6.83333H4.33333M9.33333 1H5C3.59987 1 2.8998 1 2.36502 1.27248C1.89462 1.51217 1.51217 1.89462 1.27248 2.36502C1 2.8998 1 3.59987 1 5V13.6667C1 15.0668 1 15.7669 1.27248 16.3016C1.51217 16.772 1.89462 17.1545 2.36502 17.3942C2.8998 17.6667 3.59987 17.6667 5 17.6667H10.3333C11.7335 17.6667 12.4335 17.6667 12.9683 17.3942C13.4387 17.1545 13.8212 16.772 14.0608 16.3016C14.3333 15.7669 14.3333 15.0668 14.3333 13.6667V6L9.33333 1Z" stroke="#027A48" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`;
            ...
            <div class="bg-gray-50 rounded-md -mx-6">
                ...
                <DataTable :headers="tableHeaders" :items="tableItems" :loading="loading" :show-checkbox="canBulkDelete"
                    ...
                    <template #custom-actions="{ item }">
                        <v-btn v-if="item.actions?.zone_site_track?.can_access" icon variant="text" size="small"
