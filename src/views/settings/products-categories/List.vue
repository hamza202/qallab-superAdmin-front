...
const openCreateCategory = () => {
    router.push({ name: "ProductsCategoriesCreate" });
};
...
<template>
    <default-layout>
        ...
        <DeleteConfirmDialog v-model="showDeleteDialog" :loading="deleteLoading" :title="$t('pages.productsCategories.list.deleteDialog.title')"
            :message="$t('pages.productsCategories.list.deleteDialog.message', { count: selectedCategories.length })" @confirm="confirmBulkDelete" />
