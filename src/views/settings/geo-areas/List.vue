  ...
  <default-layout>
    <div class="geo-areas-page">
      ...
      <div class="bg-gray-50 rounded-md -mx-6">
        <div 
          class="flex flex-wrap items-center gap-3 justify-between border-y border-y-slate-300 px-4 sm:px-6 py-3">
          ...
          <h3 v-else class="text-gray-900 text-lg font-bold">تقسيمات المناطق الجغرافية</h3>
          ...
          <div class="flex flex-wrap gap-3">
            ...
            <ButtonWithIcon variant="flat" color="primary-100" height="40" rounded="4"
              ...
              :prepend-icon="plusIcon" :label="t('common.addNew')" @click="openCreateGeoArea" />
          </div>
        </div>
        ...
        <DataTable :headers="geoAreasTableHeaders" :items="geoAreasTableItems"
