  ...
  <default-layout>
    <div class="cities-page">
      ...
      <div class="bg-gray-50 rounded-md p-4 sm:p-6">
        ...
        <DataTable title="الدول" :headers="citiesTableHeaders" :items="citiesTableItems" show-actions
          :show-delete="false" class="mt-6" @edit="handleEditCity" @delete="handleDeleteCity" />
