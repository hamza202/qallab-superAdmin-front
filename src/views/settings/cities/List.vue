...
<template>
  <default-layout>
    ...
    <DeleteConfirmDialog v-model="showDeleteDialog" :loading="deleteLoading" :title="$t('pages.cities.list.deleteDialog.title')"
      :message="$t('pages.cities.list.deleteDialog.message', { count: selectedCities.length })" @confirm="confirmBulkDelete" />
