...
const citiesIcon = `<svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="cities-page">
      ...
      <div class="bg-gray-50 rounded-md -mx-6">
        <div :class="hasSelectedCities ? 'justify-between' : 'justify-end'"
          ...
          <div class="flex flex-wrap gap-3">
            ...
            <v-btn variant="flat" color="primary" height="40" class="px-7 font-semibold text-base"
              prepend-icon="mdi-plus-circle-outline" @click="openCreateCity">
              اضف جديد
            </v-btn>
          </div>
        </div>
        ...
        <div v-if="showAdvancedFilters"
          ...
          <div class="flex flex-col sm:flex-row gap-3 sm:items-center justify-between">
            ...
            <div class="flex flex-wrap gap-3 flex-1 order-1 sm:order-2 justify-end sm:justify-start">
              ...
              <v-text-field v-model="filterMobileCode" density="comfortable" variant="outlined" hide-details
        ...
        <DataTable :headers="citiesTableHeaders" show-checkbox :items="citiesTableItems" show-actions
           @edit="handleEditCity" @delete="handleDeleteCity" @select="handleSelectCity"
          @selectAll="handleSelectAllCites" />
