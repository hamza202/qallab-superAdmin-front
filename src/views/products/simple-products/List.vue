...
const handleEdit = (item: any) => {
  router.push({ name: 'SimpleProductEdit', params: { id: item.id } })
}
...
<template>
  <default-layout>
    <div class="simple-products-page">
      <PageHeader :icon="simpleProductsIcon" title-key="pages.simpleProducts.title" description-key="pages.simpleProducts.description" />
