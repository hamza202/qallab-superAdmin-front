...
// Table headers
const tableHeaders = [
  { key: 'service', title: 'الخدمة', width: '200px' },
...
const tableItems = ref([
  { id: 1, service: 'خدمة 1', createdAt: '12/07/2025', status: true },
  { id: 2, service: 'خدمة 2', createdAt: '13/07/2025', status: false },
  { id: 3, service: 'خدمة 3', createdAt: '14/07/2025', status: true },
])
...
const handleEdit = (item: any) => {
  router.push({ name: 'ServicesPriceListEdit' })
}
