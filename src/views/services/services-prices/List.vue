...
const servicesPricesIcon = `<svg width="43" height="35" viewBox="0 0 43 35" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<template>
  <default-layout>
    <div class="services-prices-page">
      <PageHeader :icon="servicesPricesIcon" title-key="pages.servicesPricesList.title"
        description-key="pages.servicesPricesList.description" />
        ...
        <div :class="hasSelected ? 'justify-between' : 'justify-end'"
          ...
          <div class="flex flex-wrap gap-3">
            ...
            <ButtonWithIcon variant="flat" color="primary-100" height="40" rounded="4"
              ...
              :prepend-icon="plusIcon" label="أضف قائمة" @click="openCreate" />
          </div>
        </div>
