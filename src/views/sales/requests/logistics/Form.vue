...
<template>
    <default-layout>
        <div class="request-material-product-page  -mx-6 bg-qallab-dashboard-bg space-y-4">
            <AppFormBreadcrumb
                list-path="/sales/requests/logistics/list"
                module-root-key="breadcrumb.sales.root"
                list-label-key="breadcrumb.sales.requests.logistics.list"
                create-label-key="breadcrumb.sales.requests.logistics.create"
                edit-label-key="breadcrumb.sales.requests.logistics.edit"
