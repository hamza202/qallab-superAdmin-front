    ...
    <div class="invoice-print-page" dir="rtl">
        ...
        <div v-else-if="!isLoading && !loadFailed" class="invoice-content">
            ...
            <div class="quot-intro-block" dir="rtl">
                ...
                <p class="quot-body-text">{{ introBody }}</p>
            </div>
            ...
            <div class="project-section project-section--notes" dir="rtl">
                ...
                <ul class="terms-list">
                    <li v-for="(note, i) in staticNotes" :key="i">{{ note }}</li>
                </ul>
            </div>
...
const introBody = computed(() => {
    ...
    const projectPart =
        projectName && String(projectName).trim()
            ? `لمشروعكم ${String(projectName).trim()}`
            : 'لمشروعكم'

    const locationPart =
        location && String(location).trim()
            ? `حسب الموقع ${String(location).trim()}`
            : ''
...
const staticNotes = computed(() => {
    ...
    return [
        ...
        `صلاحية عرض السعر ${fmt(validityDays)} أيام.`,
        `يتم رفع مستخلص خلال ${fmt(invoiceIntervalDays)} أيام على أن يتم سدادها بعد ${fmt(paymentTermDays)} أيام.`,
