...
const discountTypeOptionsList = computed(() => props.discountTypeOptions || [
  { title: t('sales.forms.paymentsDemo.percentSign'), value: 1 },
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <TextInput :label="t('sales.forms.common.labels.unloadingOfficer')" v-model="form.downloading_responsible_party"
            :placeholder="t('sales.forms.common.placeholders.enterUnloadingResponsible')" density="comfortable" :rules="[required()]" />
                    <PriceInput :label="t('sales.forms.common.labels.transportAmount')" show-rial-icon v-model="form.transport_amount" :placeholder="t('sales.forms.common.placeholders.transportAmount')" density="comfortable"
            :rules="[required()]" />
          <TextInputWithSelect
            v-model="form.discount_val"
            v-model:selectValue="form.discount_type"
            :label="t('sales.forms.common.labels.discount')"
            :placeholder="t('sales.forms.common.labels.discount')"
            type="number"
            density="comfortable"
            select-width="80px"
