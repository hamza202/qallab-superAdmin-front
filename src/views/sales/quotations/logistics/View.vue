        ...
        <div class="category-view-page -mx-6">
            ...
            <div>
                ...
                <div class="flex flex-wrap items-center gap-3 mb-6 text-sm px-6">
                    ...
                    <span class="text-lg text-gray-300">/</span>
                    <router-link to="/sales/quotations/logistics/list" class="text-gray-600 hover:text-primary-600">
                        {{ t('sales.forms.viewPages.lists.quotationsLogisticsServices') }}
                    </router-link>
                    <span class="text-lg text-gray-300">/</span>
...
const fetchQuotationData = async () => {
    ...
    try {
        const res = await api.get<any>(`/sales/quotations/logistics/${routeId.value}`)
