        ...
        <div class="category-view-page -mx-6">
            <div>
                <div class="flex flex-wrap items-center gap-3 mb-6 text-sm px-6">
                    ...
                    <span class="text-lg text-gray-300">/</span>
                    <router-link to="/sales/orders/fuels/list"
                        class="text-gray-600 hover:text-primary-600">
                        {{ t('sales.forms.viewPages.lists.fuelsOrders') }}
                    </router-link>
                    <span class="text-lg text-gray-300">/</span>
                ...
                <v-tabs-window v-model="activeTab">
                    <v-tabs-window-item :value="0">
                        <div class="p-6 border-b !border-gray-200">
                            <h2 class="text-xl font-bold text-primary-900 mb-6">{{ t('sales.forms.viewPages.sections.orderInfo') }}</h2>
                            ...
                            <div class="flex flex-wrap gap-4">
                                ...
                                <v-divider vertical class="my-6"></v-divider>
                                <div class="info-item-bordered flex-1 px-6 py-4">
                                    <label class="font-semibold text-sm text-gray-500 mb-2 block">{{ t('sales.forms.common.labels.materialDeliveryLocation') }}</label>
                                    <p class="text-base font-semibold text-gray-900">{{ targetLocation }}</p>
                                </div>
                                <v-divider vertical class="my-6"></v-divider>
                                <div class="info-item-bordered flex-1 px-6 py-4">
                                    <label class="font-semibold text-sm text-gray-500 mb-2 block">{{ t('sales.forms.common.labels.departureLocation') }}</label>
                        ...
                        <div class="mb-8">
                            <div class="flex flex-wrap gap-3 items-center justify-between bg-primary-50 px-6 py-3">
                                <div class="flex items-center gap-2 text-primary-900">
                                    ...
                                    <h2 class="text-lg font-bold">{{ t('sales.forms.viewPages.sections.fuelsLogisticsBlock') }}</h2>
                                </div>
                            </div>
...
const fetchRequestData = async () => {
    ...
    try {
        ...
        error(e?.response?.data?.message || t('sales.forms.common.messages.loadFuelsOrderViewFailed'))
    } finally {
...
const requestType = computed(() => {
    ...
    if (type === 'purchase_request_with_logistics') return t('sales.forms.viewPages.requestKind.purchaseWithLogistics')
    return type || ''
})
...
const tabs = computed(() => [
    {
        title: t('sales.forms.viewPages.tabs.fuelsGeneral'),
        value: 0,
    ...
    {
        title: t('sales.forms.viewPages.tabs.fuelsProducts'),
        value: 1,
    ...
    {
        title: t('sales.forms.viewPages.tabs.fuelsTransport'),
        value: 2,
