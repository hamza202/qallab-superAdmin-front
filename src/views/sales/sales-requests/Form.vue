...
const handleSubmit = async () => {
    ...
    try {
        ...
        // router.push({ name: 'SalesRequestsList' });
...
<template>
    <default-layout>
        <div class="request-material-product-page -mx-6 bg-qallab-dashboard-bg space-y-4">
            <!-- Page Header -->
            <TopHeader :icon="filePlusIcon" title-key="pages.SalesRequests.FormTitle"
                description-key="pages.SalesRequests.FormDescription" :show-action="false" code="#124098"
