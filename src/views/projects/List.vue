            ...
            <div class="bg-gray-50 rounded-md -mx-6">
                ...
                <div v-if="showAdvancedFilters"
                    ...
                    <div class="flex flex-wrap gap-3 items-end">
                        <v-text-field v-model="filterProjectNumber" density="comfortable" variant="outlined" hide-details
                            placeholder="رقم المشروع" class="w-full sm:w-40 bg-white" />
                        ...
                        <v-text-field v-model="filterStartDateMin" type="date" density="comfortable" variant="outlined" hide-details
                            placeholder="اقل تاريخ بدء" class="w-full sm:w-40 bg-white" />
                        <v-text-field v-model="filterStartDateMax" type="date" density="comfortable" variant="outlined" hide-details
                            placeholder="اعلى تاريخ بدء" class="w-full sm:w-40 bg-white" />
                        ...
                        <v-btn variant="outlined" color="gray-500" height="40" class="font-semibold border-gray-400"
                            @click="resetFilters">
                            <template #prepend>
